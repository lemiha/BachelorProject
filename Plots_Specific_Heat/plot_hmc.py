...
hmc_error = np.genfromtxt('data_errorhmc.csv', delimiter='\n')

kappa = np.genfromtxt('data_hmc.csv', delimiter=',')[:,0]
susp = np.genfromtxt('data_hmc.csv', delimiter=',')[:,1]

plt.errorbar(kappa, susp, yerr=hmc_error, marker = 'o', capsize=5, markersize = 5, label = 'HMC w. Metro')
