...
hmc_names = np.sort(glob.glob("hmc_omf2/autoh*.dat"))
...
np.savetxt("data_tauint_omf2.csv",  np.c_[all_tauint[0], all_tauint[1], all_tauint[2], all_tauint[3], all_tauint[4], all_tauint[5], all_tauint[6], all_tauint[7]],
